      ...
      {isConfirmed && (
        <section className={styles.section}>
          <div className={styles.detailActions}>
            <button className={styles.outlineBtn} onClick={() => onNavigate({ type: 'cancel', orderId: order.id })}>
      ...
      {hasReturnWindow && (
        <section className={styles.section}>
          <div className={styles.exchangeActions}>
            ...
            <button className={styles.exchangeBtn} onClick={() => onNavigate({ type: 'size-exchange', orderId: order.id })}>
              <ExchangeIcon /> Size Exchange
            </button>
            <button className={styles.exchangeBtn} onClick={() => onNavigate({ type: 'return', orderId: order.id })}>
