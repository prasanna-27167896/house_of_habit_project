                ...
                <table border={0} cellPadding={0} cellSpacing={0} width="600" className="container" style={{ backgroundColor: "#FAFAFA", maxWidth: "600px" }}>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center" className="hero-content" style={{ backgroundColor: "#FAFAFA", backgroundImage: "url('bg-image.png')", backgroundPosition: "top center", backgroundSize: "100% auto", backgroundRepeat: "no-repeat", padding: "270px 10px 0 10px" }}>
                            ...
                            <tr>
                              <td align="left" style={{ paddingBottom: "24px" }}>
                                ...
                                <p style={{ color: "#1f2937", fontSize: "16px", lineHeight: 1.6, margin: 0 }}>
                                  We received a request to reset your password. Use the OTP below to complete the verification process.
                                </p>
                              </td>
                            </tr>
                          </tbody>
